...
var connectionString = configuration.GetConnectionString("FCGPaymentDbConnection")
                            ?? throw new ArgumentNullException("Connection string 'FCGPaymentDbConnection' not found.");
...
{
    c.SwaggerDoc("v1", new() { Title = "FCG.Payments.API", Version = "v1" });
